...
class TextRank4Sentence(object):
    def __init__(self, use_stopword=False, stop_words_file=None, use_w2v=False, dict_path=None, max_iter=100,
        ...
        :param tol: 最大容忍误差
        """
        if use_w2v is False and dict_path is not None:
        ...
        self.__tol = tol
        if self.__use_w2v:
            self.__word2vec = KeyedVectors.load_word2vec_format(self.__dict_path)
        self.__stop_words = set()
        self.__stop_words_file = get_default_stop_words_file()
